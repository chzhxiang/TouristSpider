...
Field(fieldname=FieldName.COMMENT_YEAR, css_selector='div.header > div > span.date',filter_func=get_comment_year, is_info=True),
Field(fieldname=FieldName.COMMENT_SEASON, css_selector='div.header > div > span.date',filter_func=get_comment_season, is_info=True),
Field(fieldname=FieldName.COMMENT_MONTH, css_selector='div.header > div > span.date',filter_func=get_comment_month, is_info=True),
    Field(fieldname=FieldName.COMMENT_WEEK, css_selector='div.header > div > span.date',filter_func=get_comment_week, is_info=True),
